/* GERADO por ferramentas/build_ativos.py -- edite fonte/js/clp.js */
(function () {
"use strict";
...
var X0 = -2.55, X1 = 2.55;
caixa(0, -1.02, 0, (X1 - X0) / 2, .10, .09, 1, 0);
caixa(0, .10, -.02, (X1 - X0) / 2, .92, .06, 1, 0);
for (var i = 0; i < 26; i++) {
